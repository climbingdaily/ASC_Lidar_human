...
def icp_without_rotation(source_points, target_points, target_kdtree, iteration=3):
...
def mocap_to_lidar(mocap_points, C, lidar_points=None, translation=None):
    ...
    return affine(mocap_points_translated, np.linalg.inv(C))
